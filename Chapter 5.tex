...
An interesting part of the examples is the amount of contexts they cover from the original ADEC proposal. Whereas the definitions focused on teaching and learning, there are far more high level and whole school contexts mentioned. There is an indication therefore, that despite innovation being hard to define, teachers can give good examples of innovation in schools.

\subsubsection{Students}
TODO:

\subsection{Introduction of Innovation}
At the time of writing, less than one academic year has passed since the introduction of the new framework which highlighted innovation. From the data provided by questionnaires within the UAE, 75\% of replies indicated that yes, their school had made changes since the start of the academic year. 12.5\% replied they had not and 12.5\% were unsure. Given the varying nature of the job responsibilities for those who responded, the results are indicating that most schools have acknowledge and embraced the changes. Those who responded to the negative would prove difficult to corroborate without going into their school and questioning senior staff. While some schools may have made their changes obvious, some may not have. Just because a change was not noticed by all does not mean it has not happened. It could be argued however that as a whole-school focus, teachers should be aware of any possible changes made.

Of those who had replied that their school had made changes, they were invited to provide examples of the changes made. Example of changes included:

\begin{itemize}
\item Subject specific innovation classes. Encouraging and demonstrating innovative teaching tools and methods
\item Innovation day (all school project), teaching with I-pad [sic], different apps, Flipping [sic] the classroom, use of augmented reality, online assessment, etc....
\item New SEN programs have been trialed. [sic]
\end{itemize}

One respondent replied with some paraphrased examples from their ADEC inspection report which have been edited for relevancy:
...
While these constitute some good examples, as with the earlier discussion of inspections being generous towards the definition of innovation, it is illuminating to note that both group work and effective questioning are highlighted as good examples of innovation. By any definition of innovation that is quite a stretch, as these ideas have been cemented in good teaching practice for many years. This is of importance to developing a better understanding of innovation, because it does support the theory that the topic itself is both difficult to define and measure. This is seen by this example of highlighting everyday good teaching practice as innovation by a group of experience inspectors in this way.
