...
As previously touched upon, the term and concept of innovation was one which at times could be fairly loosely defined. One of the first questions posed to subjects was to ask them what their definition of innovation was within a school context.
...
\begin{tabular}{@{}ll@{}}
\toprule
\multicolumn{1}{c}{\textbf{Related to teaching and learning}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             & \multicolumn{1}{c}{\textbf{Unrelated to teaching and learning}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \\ \midrule
\begin{tabular}[c]{@{}l@{}}Incorporating current real life events, technological,\\ cultural and political advancements into teaching and learning\\ \\ Thinking differently about the way you teach / the\\ way the students learn\\ \\ Innovation in education is about constantly\\ reflecting on our daily practice and our pedagogical approach, {[}…{]} action\\ research and looking on what we can improve and change in our teaching.\\ \\ Allowing students to face challenges is also\\ allowing them to be critical thinkers and problem solvers\end{tabular} & \begin{tabular}[c]{@{}l@{}}A change in the value system within education. {[}…{]} Understanding present context; researching, experimenting, analysing the new\\ before we ring out the old. {[}...{]}\\ \\ \\ Innovation is being creative\\ \\ \\ Dare to try something new and not always guaranteed\\ \\ \\ Innovation is creativity and willingness to take\\ risks in order to bring fresh, new ideas.\\ \\ \\ {[}…{]} On a larger scale innovation comes from a wide\\ range of components in schools' namely timings of the day, timetabling, lesson\\ structure and opportunities.\end{tabular} \\ \bottomrule
\end{tabular}%
}
\caption{Teacher definitions of innovation}
\label{teacher-definitions}
\end{table}
