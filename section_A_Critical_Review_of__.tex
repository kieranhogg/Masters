...
Innovation, as previously discussed, is an idea that is application to almost any context. Research into innovation outside the sphere of education is certainly prevalent, and the publications discussed are those that have been chosen to have some parallels or application with the target context of schools.
