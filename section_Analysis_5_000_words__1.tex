...
\begin{table} 
    \begin{tabular}{ c c }
        Definitions related to teaching and learning & Others \\ 
Incorporating current real life events, technological, cultural and political advancements into teaching and learning
Thinking differently about the way you teach / the way the students learn
Innovation in education is about constantly reflecting on our daily practice and our pedagogical approach, […] action research and looking on what we can improve and change in our teaching.
Allowing students to face challenges is also allowing them to be critical thinkers and problem solvers
        & 
A change in the value system within education. […] Understanding present context; researching, experimenting, analysing the new before we ring out the old. [...]
Innovation is being creative
Dare to try something new and not always guaranteed
Innovation is creativity and willingness to take risks in order to bring fresh, new ideas.
[…] On a larger scale innovation comes from a wide range of components in schools' namely timings of the day, timetabling, lesson structure and opportunities.
        \\ 
    \end{tabular} 
\end{table}
